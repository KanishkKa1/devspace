  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 pb-24 animate-fade-in-up">
      ...
      <div className="mb-12 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        ...
        <Link 
          href="/blog/async-workflow-case-study"
        ...
        >
          <span>Next: Async Decoupling</span>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        {/* Footer Navigation */}
        <Link href="/blog/async-workflow-case-study" className="block pt-12 border-t border-slate-200 dark:border-neutral-800 flex justify-between items-center hover:opacity-80 transition-opacity cursor-pointer group">
          <div>
             <span className="text-xs text-slate-500 uppercase tracking-widest block mb-1">Context</span>
             <h4 className="font-semibold text-slate-800 dark:text-slate-200 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Async Decoupling</h4>
          </div>
